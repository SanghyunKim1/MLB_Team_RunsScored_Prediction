...
The bar plot above displays how the **league average runs scored** changed over time since the 2000 season. As we can see, although there were slight fluctuations, teams were able to score relatively many runs on average up until the mid 2000's (2000 ~ 20006). </br>
